...
\begin{tikzpicture}
  ...
  \SpongeDecrypt{$P_0$}{$C_0$}{\Asconp{8}}{128\quad\null}{192}
  \SpongeEtc
  \SpongeDecrypt{\hskip-8pt$P_{n\!-\!1}$}{$C_{n\!-\!1}$\hskip-8pt\null}{\Asconp{8}}{128}{192}
  \draw (x|-phase) node[spongephase] {Ciphertext};
  \SpongeDecryptFinal{$P_n$}{$C_n$}{   }{192}
