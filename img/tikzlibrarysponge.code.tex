...
%   Version: 2019-02-14 (with tweaks 2024-11-06)                               %
...
\newcommand{\SpongeEncrypt}[5]{
  % (placement of #4 edited compared to original version!)
  \SpongeStep
  ...
  \draw[next] (t) -- (C);
  \draw (x.west) node[bitwidth, above left] {#4};
