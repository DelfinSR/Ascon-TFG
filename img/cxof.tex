...
\begin{tikzpicture}
  ...
  \SpongeAbsorb{$Z_0$}{\Asconp{12}}{64\quad\null}{\quad256}
  \SpongeEtc
  \SpongeAbsorb{$Z_m$}{\Asconp{12}}{}{256}
  \draw (x|-phase) node[spongephase] {Customization};
  \SpongeStep\SpongePhaseSep

  \SpongeAbsorb{$M_0$}{\Asconp{12}}{64\quad\null}{\quad256}
  \SpongeEtc
  \SpongeAbsorb{$M_n$}{\Asconp{12}}{}{256}
  \draw (x|-phase) node[spongephase] {Absorb Message};
  \SpongeStep\SpongePhaseSep

  \SpongeSqueeze{$H_0$}{\Asconp{12}}{64\quad\null}{\quad256}
  \SpongeEtc
  \SpongeSqueeze{$H_{\lceil L/64 \rceil - 1}$}{\Asconp{12}}{}{256}
